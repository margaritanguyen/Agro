...
namespace Agro.DataAccess.Migrations
{
    ...
    [Migration("20230619114559_Change_Resource")]
    partial class Change_Resource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agro.DataAccess.Entities.BatchReport", b =>
                {
                    ...
                    b.ToView("BatchReportView", (string)null);
                });
            ...
            modelBuilder.Entity("Agro.DataAccess.Entities.TechCardReport", b =>
                {
                    b.Property<int>("BatchNum")
                        .HasColumnType("int");
                    ...
                    b.ToView("TechCardReportView", (string)null);
                });
            ...
            modelBuilder.Entity("Agro.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$iQ9Lx2XY2wWGNvfJQd8jae052lR1wcYcrXT2FYpXq7/i3Z1cvEOum",
                            UserName = "admin",
                            UserRoleId = 1
                        });
                });
